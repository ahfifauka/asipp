...
use DateTime;
use Excel;
use App\Http\Controllers\Export\ExcelUsulanPenelitian;
use App\Http\Controllers\Export\ExcelUsulanPengabmas;
use App\Http\Controllers\Export\ExcelLaporanKemajuanPenelitian;
use App\Http\Controllers\Export\ExcelLaporanKemajuanPengabmas;
use App\Http\Controllers\Export\ExcelLaporanAkhirPenelitian;
use App\Http\Controllers\Export\ExcelLaporanAkhirPengabmas;
use App\Http\Controllers\Export\ExcelPlotReviewerUsulanPenelitian;
use App\Http\Controllers\Export\ExcelPlotReviewerUsulanPengabmas;
use App\Http\Controllers\Export\ExcelPlotReviewerKemajuanPenelitian;
use App\Http\Controllers\Export\ExcelPlotReviewerKemajuanPengabmas;
...
class AdminController extends Controller
{
    ...
    {
        return Excel::download(new ExcelUsulanPenelitian(), 'Usulan Penelitian - '. date('Y-m-d H:i:s') .'.xlsx');
    ...
    {
        return Excel::download(new ExcelUsulanPengabmas(), 'Usulan Pengabmas - '. date('Y-m-d H:i:s') .'.xlsx');
        return redirect()->back();
    }
    ...
    {
        return Excel::download(new ExcelLaporanKemajuanPenelitian(), 'Laporan Kemajuan Penelitian - '. date('Y-m-d H:i:s') .'.xlsx');
        return redirect()->back();
    }
    ...
    {
        return Excel::download(new ExcelLaporanKemajuanPengabmas(), 'Laporan Kemajuan Pengabmas - '. date('Y-m-d H:i:s') .'.xlsx');
        return redirect()->back();
    }
    ...
    {
        return Excel::download(new ExcelLaporanAkhirPenelitian(), 'Laporan Akhir Penelitian - '. date('Y-m-d H:i:s') .'.xlsx');
        return redirect()->back();
    }
    ...
    {
        return Excel::download(new ExcelLaporanAkhirPengabmas(), 'Laporan Akhir Pengabmas - '. date('Y-m-d H:i:s') .'.xlsx');
        return redirect()->back();
    }
    ...
    {
        return Excel::download(new ExcelPlotReviewerUsulanPenelitian(), 'Plot Reviewer Usulan Penelitian - '. date('Y-m-d H:i:s') .'.xlsx');
        return redirect()->back();
    }

    public function downloadreviewerusulanpengabmas(Request $request, $type)
    {
        return Excel::download(new ExcelPlotReviewerUsulanPengabmas(), 'Plot Reviewer Usulan Pengabmas - '. date('Y-m-d H:i:s') .'.xlsx');
        return redirect()->back();
    }
    ...
    {
        return Excel::download(new ExcelPlotReviewerKemajuanPenelitian(), 'Plot Reviewer Kemajuan Penelitian - '. date('Y-m-d H:i:s') .'.xlsx');
        return redirect()->back();
    }

    public function downloadreviewerkemajuanpengabmas(Request $request, $type)
    {
        return Excel::download(new ExcelPlotReviewerKemajuanPengabmas(), 'Plot Reviewer Kemajuan Pengabmas - '. date('Y-m-d H:i:s') .'.xlsx');
        return redirect()->back();
    }
